                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title">Edit  Driver
                                    <span class="badge bg-info">{{$driver->name}}</span>
                                </h4>

                                {!! Form::model($driver,['route'=>['admin.drivers.update',$driver->id],'method'=>'PUT','role'=>'form','class'=>'form-horizontal','files'=>true]) !!}
